...
> Owner-only WhatsApp group creation, response settings, and connector setup links
...
Important WhatsApp platform limitations: the agent can only create new WhatsApp groups; it cannot be added to an existing WhatsApp group. Each agent-created WhatsApp group is limited to 7 participants. Explain these limits plainly when a user asks to connect or create WhatsApp groups.
